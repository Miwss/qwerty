...
public class slova3 {
    public static void main(String[] args) {
        ...
        List<slova2.Word> list = detectAllWords(crossword, "AGAINST" );

        for (slova2.Word words : list)
...
same - (1, 1) - (4, 1)
    ...
    public static List<slova2.Word> detectAllWords(int[][] crossword, String... words) {
        List<slova2.Word> list = new ArrayList<>();
                        ...
                        for (int[] arrTwo : crossword) {
                            for (int posX2 = 0; posX2 < arr.length; posX2++) {
                                ...
                                if (absX == lengWord && absY == lengWord || absX == 0 && absY == lengWord || absX == lengWord && absY == 0) {
                                    ...
                                    slova2.Word foundWord = new slova2.Word(word);
